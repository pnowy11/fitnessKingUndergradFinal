        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <form id="login-form" class="form" action="registerdetail.php" method="post" style= "margin-top: 120px;max-width: 600px;height: 560px;border: 1px solid #9C9C9C;background-color: #EAEAEA;padding: 20px;">
                        <h3 class="text-center">Register</h3>
                        <div class="form-group">
                            <label for="username">Username:</label><label class="text-danger">*</label><br>
                            <input type="text" name="username" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email:</label><label class="text-danger">*</label><br>
                            <input type="email" name="email" class="form-control" required>
                        </div>
						<div class="form-group">
                            <label for="password">Password:</label><label class="text-danger">*</label><br>
						...
						<div class="form-group">
                            ...
                            <select name="gender" style="max-width: 100px;" class="form-select">
