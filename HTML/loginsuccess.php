...
<br>
<br>
<h3>You have successfully logged in, <?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}
                else echo "User"?></h3>
<br>
<button class='btn btn-primary' style='background-color: #853394; border-color:#853394;' onclick=document.location='Routines.php'>Account</button>
</center>
</div>
</body>
